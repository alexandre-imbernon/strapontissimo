<?php
session_start();
$user_id = $_SESSION['user_id']; // ID utilisateur récupéré après authentification

$mysqli = new mysqli("localhost", "root", "root", "strapontissimo");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $mysqli->prepare($sql);
    $stmt->bind_param("ssssssssi", $nom, $prenom, $adresse, $email, $password, $city, $postcode, $tel, $user_id);
