...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $pass = $_POST['password'];
    // $hashed_password = '$2y$10$[hash de votre base de données]'; // Remplacez par le hash réel
    // $input_password = 'asmalafraude';
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="login_admin.php" method="post">
                ...
                <p>Pas de compte ? <a href="register_admin.php">Inscrivez-vous ici</a></p>
            </form>
        </div>
